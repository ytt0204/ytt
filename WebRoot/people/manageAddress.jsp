...
<c:redirect url="../AddressBook.action?oper=showall"></c:redirect>
</c:if>
...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <h3>我的地址列表</h3>
<form name="form2" action="../AddressBook.action" method="post">
<input type="hidden" name="oper" value="delpl"/>

<table width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
	<td height="25" colspan="10" >&nbsp;地址列表&nbsp;
...
<tr align="center" bgcolor="#FAFAF1" height="22">
	...
	<c:forEach items="${sessionScope.addresslist}" var="ac" >
		...
		<td><input name="cid" type="checkbox" id="id" value="${ac.addressid }" class="np"></td>
		<td>${ac.addressid }</td>
		<td>${ac.receiver}</td>
		<td>${ac.phone}</td>
		<td>${ac.address}</td>
		...
		<td>
		<a href="javascript:delbyid('../AddressBook.action?oper=delbyid&id=${ac.addressid }')">删除</a></td>
	</tr>
	</c:forEach>
...
<td height="30" colspan="10">
	&nbsp;
	<a href="addAddressbook.jsp" class="coolbg">添加</a>&nbsp;&nbsp;
